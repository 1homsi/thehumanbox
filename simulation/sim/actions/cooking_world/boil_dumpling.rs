...
pub fn apply(ctx: &mut ActionCtx) -> f32 {
    ...
    o.energy = (o.energy + 0.14).min(1.0);
    o.comfort = (o.comfort + 0.04).min(1.0);
    let cur = o.tools.get("dumpling").copied().unwrap_or(0);
    o.tools.insert("dumpling".to_string(), (cur + 1).min(15));
    ctx.think("boil dumpling");
    ctx.event("life", "boiled dumpling");
    0.010
}
