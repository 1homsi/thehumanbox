...
pub fn apply(ctx: &mut ActionCtx) -> f32 {
    ...
    let cur = o.tools.get("consomme").copied().unwrap_or(0);
    o.tools.insert("consomme".to_string(), (cur + 1).min(15));
    ctx.think("reduce consomme");
    ctx.event("life", "reduceed consomme");
    0.010
}
