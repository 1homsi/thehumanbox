...
pub fn apply(ctx: &mut ActionCtx) -> f32 {
    ...
    ctx.discover("perseverance", "chose to carry on the work left behind by the fallen");
    ctx.event("culture", "the tribe continues the unfinished work of those who have passed");
    0.008
}
