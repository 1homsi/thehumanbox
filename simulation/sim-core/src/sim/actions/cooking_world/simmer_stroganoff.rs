...
pub fn apply(ctx: &mut ActionCtx) -> f32 {
    ...
    let cur = o.tools.get("stroganoff").copied().unwrap_or(0);
    o.tools.insert("stroganoff".to_string(), (cur + 1).min(15));
    ctx.think("simmer stroganoff");
    ctx.event("life", "simmered stroganoff");
    0.010
}
