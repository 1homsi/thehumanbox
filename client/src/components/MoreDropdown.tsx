    ...
    <div className="more-dropdown">
      ...
      <div className="more-dropdown-grid">
        ...
        <button
          ...
          title="Food / water / path stigmergy blended"
        >
          ⋯ trails
        </button>
        <button
        ...
        <button
          ...
          title="Where organisms feel fearful"
        >
          🜸 threat
        </button>
      </div>
      ...
      <div className="more-dropdown-grid">
        ...
        <button
          ...
          title="Highlight sick organisms"
        >
          🤒 sick
        </button>
        <button
          ...
          title="Highlight starving organisms"
        >
          😫 hungry
        </button>
        <button
        ...
        <button
          ...
          title="Highlight thriving organisms"
        >
          ✦ thriving
        </button>
      </div>
      ...
      <div className="more-dropdown-grid">
        <button
          ...
          title="Colored dot per organism showing tribe affiliation"
        >
          ⬤ lineage
        </button>
        <button
        ...
        <button
          ...
          title="Age tint: child / adult / elder"
        >
          ⏳ age
        </button>
        <button
        ...
        <button
          ...
          title="Bond line between partners"
        >
          ♥♥ pairs
        </button>
        <button
        ...
        <button
          ...
          title="Food / water / path stigmergy"
        >
          ⋯ trails
        </button>
        <button
          ...
          title="Highlight huts and campfires"
        >
          ⌂ builds
        </button>
        <button
        ...
        <button
          ...
          title="Hazard scars - violence and death"
        >
          ✶ hazard
        </button>
        <button
          ...
          title="Per-lineage drift over the last ~60 sim-days"
        >
          ↝ history
        </button>
        <button
          ...
          title="Frames-per-second + frame timing"
        >
          ⏱ perf
        </button>
        <button
          ...
          title="3D territory overlay - lineage claims and contested zones"
        >
          ⬡ territory 3d
        </button>
      </div>
      ...
      <div className="more-dropdown-grid">
        ...
        <button
          ...
          title="Build info, versions, and links"
        >
          ⓘ about
        </button>
        <button
      ...
      <div className="more-dropdown-grid">
        ...
        <button
          className={clsx('lang-btn', actionTicker && 'active')}
          aria-pressed={!!actionTicker}
