...
const WALL_COLORS: Record<string, string> = {
  ...
  Plaza: '#a89880',
  Statue: '#b0b0b0',
  Tavern: '#7a4a28', Brewery: '#7a4a28', Butcher: '#a04848', Fishmonger: '#6890b0',
  Cheesemonger: '#e8c878', Tailor: '#9870a8', Cobbler: '#604030', ClothingShop: '#c870a0',
  Jeweler: '#a89060', Apothecary: '#608860', Herbalist: '#608848', Barbershop: '#c8c8c8',
  Scribe: '#c8b078', BookStore: '#684830', ArtGallery: '#a86880', MusicHall: '#5050a8',
  Cafe: '#704830', Restaurant: '#a87048', Hotel: '#c0a070', GuildHall: '#5878a8',
  Courthouse: '#a8a090', CityHall: '#b8a060', PostOffice: '#a05848',
  PoliceStation: '#3050a0', FireStation: '#c83020', Pharmacy: '#48a070',
  Clinic: '#e8e8e8', Spa: '#c8a0c0', Bathhouse: '#a0c0d8', Greenhouse: '#b0e0a0',
  Vineyard: '#80a060', Ranch: '#a87850', Stable: '#785030', Kennel: '#684838',
  Dovecote: '#a09078', Quarry: '#909090', Mine: '#605050', SawMill: '#a07848',
  Tannery: '#7a5838', Smithy: '#604030', Goldsmith: '#d8b048',
  Refinery: '#807868', PowerPlant: '#808080', Substation: '#a0a0a0', WaterTower: '#a8b0b8',
  Reservoir: '#5878a0', GasStation: '#d8a020', AutoShop: '#606060', Garage: '#707070',
  MallShop: '#a0a8b8', Supermarket: '#48a048', OfficeTower: '#88a0b8',
  Skyscraper: '#5070a0', Datacenter: '#202830', Studio: '#383848',
  Spaceport: '#a0a0c0', OrbitalLift: '#7080a0', SolarArray: '#2050a0', WindFarm: '#c8d8e8',
  FusionPlant: '#a020a0', NeuralHub: '#a050d0', AiCore: '#20c0d0', Biodome: '#80e090',
  Cryolab: '#c8e0f0', NanoFab: '#80a0c0', Hyperloop: '#404868', Maglev: '#506880',
  Hospital2: '#f0f0f0', ResearchLab: '#a8c0d8', Megastructure: '#404060',
  Well: '#807060', Lamppost: '#303030', Signpost: '#785030', MarketStall: '#c87840',
  FoodCart: '#a05030', Cart: '#604838', Tent: '#a89060', Pavilion: '#c8a878',
  Gazebo: '#a89878', Bench: '#5a3818', Fence: '#604838', Gate: '#604838',
  Watchtower: '#605040', Gallows: '#4a2a18', Monument: '#a8a098', Obelisk: '#888080',
  Shrine: '#c8a050', Cemetery: '#808080', GraveStone: '#909090',
  Garden: '#80b070', Orchard: '#608838', Pond: '#5078a0', PlayGround: '#d8a070',
  FlagPole: '#a8a8a8', Bandstand: '#a89070', Kiosk: '#a07050', BillBoard: '#b0b0b0',
  TelephonePole: '#604838', StreetLight: '#303030', BusStop: '#506888',
  ParkingLot: '#404040', Crosswalk: '#808080',
  Pyramid: '#c8a868', Ziggurat: '#a88858', Coliseum: '#a08868', TriumphalArch: '#a8a098',
  ClockTower: '#a09078', Mosque: '#a8b0c8', Synagogue: '#a0a8c0', Pagoda: '#a85040',
  Stupa: '#c8b878', Mausoleum: '#888080', Hangar: '#606060', Silo: '#a89858',
  Warehouse: '#706050', Dock: '#604838', Marina: '#5878a0', Lighthouse2: '#e0d8c8',
  Drydock: '#606870', Crane: '#a8a020', RadioTower: '#c84040', SatelliteDish: '#a0a0a0',
  WindTurbine: '#e0e0e0', SolarPanel: '#1030a0', ChargingStation: '#30c050',
  RoboticArm: '#a8a020', Drone: '#404048', HoloBoard: '#20a8d0', NeonSign: '#e020a0',
  ArcadeBox: '#3030c0', Fountain2: '#80a8c8', FoodTruck: '#c87030',
  Greenhouse2: '#c0e8b0', MushroomFarm: '#a06848', Aquaculture: '#3868a0',
  TrainStation: '#604030', Airport: '#a0a8c0', Port: '#5878a0', Stadium: '#a8a098',
  Museum: '#a8a088', Cathedral: '#c8b878', Castle: '#807868', Theatre: '#a05870',
  Observatory: '#a0a8b8',
}
...
const HOUSE_LIKE = new Set([
  ...
  'Greenhouse', 'Vineyard', 'Stable', 'SawMill', 'Tannery', 'Smithy', 'Goldsmith',
  'GasStation', 'AutoShop', 'Garage', 'MallShop', 'Supermarket',
  'OfficeTower', 'Skyscraper', 'Studio', 'Datacenter',
  'Hospital2', 'ResearchLab', 'Hangar', 'Warehouse', 'Silo',
  'Pavilion', 'Gazebo', 'Bandstand', 'Watchtower', 'Pagoda', 'Mosque',
  'Synagogue', 'Stupa', 'Mausoleum', 'ClockTower', 'Greenhouse2',
])
